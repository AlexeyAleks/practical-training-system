...
public class TestUserServiceImpl {
    ...
    public void testRead() {
        ...
        Assertions.assertEquals("User{id=1, firstName='Bob', lastName='Bobovich', email='Bob@gmail.com', " +
                        "password='111w2'}", UserServiceImpl.getInstance().readById(1, session).toString());
        session.close();
    }
    ...
    public void testDelete() {
        ...
        User user1 = new User("Bob", "Bobovich", "Bob@gmail.com", "111w2");
        UserServiceImpl.getInstance().create(user1, session);
        UserServiceImpl.getInstance().delete(user1, session);
        Assertions.assertEquals(null, UserServiceImpl.getInstance().readById(1, session));
        session.close();
    }
    ...
    public void testGetInstance() {
        ...
        Assertions.assertEquals(instance, UserServiceImpl.getInstance());
    }
}
